...
{
	//declaration to play downBoy sound
	public downBoySound hahaha;

	//declaration to play You Are Under Arrest sound
	public yauaSound rush;

	//random number generator for sounds
	private System.Random rand = new System.Random();

	//ready set.....FIGHT trigger
	public bool ReadySet = false;

	//trigger to tell that the player is in pain in the air
	public bool owAirTrigger = false;

	//debug string
	public string enemyScript;

	//attack call declaration to other player
	public PlayerController attack;

	//cutscene declaration
	...
	public string facingLeftstring;				public string velocityXString;			public string crouchingString;				public string normalFramesString;
	public string blockingString;				public string LPStringTrigger;			public string HPStringTrigger;				public string LKStringTrigger;
	public string HKStringTrigger;				public string groundString;				public string velocityYString;				public string hurtLockStringLight;
	public string hurtLockStringHeavy;			public string hitFramesString;			public string blockLockStandingString;		public string blockLockCrouchingString;
	public string gettingUpString;				public string gettingTrippedString;		public string owAirTriggerString;			public string alreadyAirString;
	public string D1triggerString;				public string SD1triggerString;			public string SD2triggerString;				public string driveFramesString;
